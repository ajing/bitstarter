...
var URL_DEFAULT = 'http://infinite-bayou-8176.herokuapp.com/';

// call back function if something goes wrong for that url
...
if(require.main == module) {
    program
        ...
        .option('-u, --url ', 'http://infinite-bayou-8176.herokuapp.com/')
        .parse(process.argv);
  if (program.url) {
